...
GEOR.custom = {
    ...
    CONTEXTS: [
        ["OpenStreetMap", "app/img/contexts/osm.png", "default.wmc", "A unique OSM layer"],
	["Administratif", "app/img/contexts/Admin.PNG", "contexts/Administratif.wmc", "Couches administratives"],
	["Altimetrie", "app/img/contexts/Alti.PNG", "contexts/Altimetrie.wmc", "Altimetrie"]
    ],
     ...
     */
    ADDONS: [{
        "id": "magnifier", // unique & stable string identifier for this addon instance
        "name": "Magnifier",
        "title": {
    ...
    CATALOGS: [
        ...
        ['http://www.georhonealpes.fr/geonetwork/srv/fre/csw-RAIN?SERVICE=CSW&VERSION=2.0.2&REQUEST=GetCapabilities', 'le catalogue GeoRhoneAlpes'],
     ...
     */
    GEONAMES_FILTERS: {
        username: 'viennagglo', // please replace this username by yours !
     ...
     */
    WMS_SERVERS: [
	{"name": "ViennAgglo", "url": "http://geo.viennagglo.fr/geoserver/wms"},
	{"name": "GeoRhoneAlpes", "url": "http://carto.georhonealpes.fr/cgi-bin/mapserv?"},
